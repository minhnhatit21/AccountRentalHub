package com.AccountRentalHub.security;

import com.AccountRentalHub.security.jwt.AuthEntryPointJwt;
import com.AccountRentalHub.security.jwt.AuthTokenFilter;
import com.AccountRentalHub.security.services.UserDetailsServiceImpl;
        ...
        http.csrf(csrf -> csrf.disable())
                ...
                .authorizeHttpRequests(auth ->
                        auth.requestMatchers("/api/auth/**").permitAll()
                                ...
                                .requestMatchers("/api/accountRentals/**").permitAll()
                                .requestMatchers("/api/customer/**").permitAll()
                                .requestMatchers("/api/rentalHistories/**").permitAll()
