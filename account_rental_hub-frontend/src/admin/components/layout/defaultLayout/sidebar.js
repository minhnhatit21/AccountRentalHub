                    ...
                    <div className="flex flex-col overflow-y-auto">
                        ...
                        <div className="flex grow h-screen">
                            <nav className="mt-5 flex-1 px-2 bg-white space-y-1">
                                ...
                                >
                                    <NavLink
                                        to="/admin/account/service"
                                        className={({ isActive }) =>
                                            classNames(
                                                isActive
                                                    ? 'bg-regal-blue text-white group flex px-2 py-2 gap-2 text-md font-medium rounded-md'
                                                    : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900 group flex px-2 py-2 gap-2 text-md font-medium rounded-md'
                                            )
                                        }
                                    >
                                        <svg
                                    ...
                                    >
                                        ...
                                        <span className="text-sm">
                                            Danh sách các tài khoản cho thuê
                                        </span>
                                    </NavLink>

                                    <NavLink
                                        to="/admin/account/accountPackage"
                                        className={({ isActive }) =>
                                            classNames(
                                                isActive
                                                    ? 'bg-regal-blue text-white group flex items-center px-2 py-2 gap-2 text-md font-medium rounded-md'
